...
::: details 以下是v0.7.1更新内容：
   - ! 谱面协作者功能：谱面现支持添加合作者信息，详细说明参见 https://teamflos.github.io/phira-docs/chart-management/collaborator.html
   - 收藏夹添加上拉刷新功能
   - 修复部分资源包判定线和特效消失的问题
   - 修复谱面无法批量导出的问题
   - 修复练习模式下拖动进度后音符无法判定的问题
   - 修复本地收藏夹无法添加在线谱面的问题
   - 修复 RPE 判定区域不支持长条的问题
   - 修复使用键盘游玩时缺少“不计入成绩”提示的问题
:::
...
- 在v0.8.0及以上的版本登录Phira，需强制绑定好游快爆账号，绑定后才能正常游玩。绑定后，账号将支持好游快爆一键登录。
