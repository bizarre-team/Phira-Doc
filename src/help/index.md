...
::: details 以下是v0.8.0&v0.8.1版本更新内容：
v0.8.0：
   - ! [好游快爆] 支持好游快爆账号一键注册登录，支持绑定旧账号并迁移数据
   - 修复部分情况下资源包消失的问题
   - 修复部分UI问题
...
## 注册/登录方式
   - 自**v0.8.0**版本开始，通过[好游快爆](https://www.3839.com/a/154061.htm)下载的Phira支持一键登录，无需经过邮箱验证
   - 邮箱注册/登录步骤如下：
      1. 点击前往[QQ邮箱，推荐](http://mail.qq.com/)、[网易邮箱](https://email.163.com/)注册邮箱。（拥有QQ账号的可以直接通过“QQ号@qq.com”）直接进行注册Phira，无需再次注册邮箱。
      2. 前往游戏内或[官网注册](https://phira.moe/register)，输入邮箱地址、用户名与想要设置的密码。
      3. 同意[《服务条款》](https://phira.moe/terms-of-use)与[《隐私政策》](https://phira.moe/privacy-policy)后，将会往你的邮箱内发送账号激活邮件，前往邮箱访问链接即可激活账号。**如果没有收到邮件记得去垃圾箱看看是否被屏蔽，还是没有建议20分钟后重试！**
      4. 激活完成后，即可登录Phira享受在线服务。
...
### 关于好游快爆版本账号登录绑定
- 在v0.8.0及以上的版本登录Phira([好游快爆版](https://www.3839.com/a/154061.htm)) ，需强制绑定好游快爆账号，绑定后才能正常游玩。绑定后，账号将支持好游快爆一键登录。
...
- 谱面加载、下载错误检查自己的软件版本是否为最新版本（0.8.0）如果为最新版本则为服务器问题，或者是访问频繁被限制，过段时间就好力。
- 谱面成绩若无法成功上传，提示：`！尚在上传成绩`意为服务器目前网络不良，若不在意成绩建议开启离线模式游玩。
::: details 针对近期谱面出现无法下载（一长串报错），或下载速度缓慢点我查看：
  - 等1小时后再上线
  - 切换网络（WiFi切换为数据流量）
  - 游戏内打开不安全模式并重启游戏
  - 开启飞行模式，或重启设备
...
:::danger
- 注意！v0.7.1版本导入错误东西将会导致皮肤清空！为已知bug，请尝试 <u>更新至v0.8.0及以上版本</u> 游玩。
:::
- 资源包（皮肤和谱面）导入的是zip文件，不需要解压喔。
- 资源包下载：
   :::tip 推荐使用[好游快爆](https://www.onebiji.com/hykb_tools/phira/index.php)
   :::
   其他下载途径：
...
- QQ群（请勿重复加群哦~）：
  - ~~好游快爆官方群1：`576660653`（已满）~~
  - 好游快爆官方群2（推荐）：`370532960`
  - ~~官方1群：`688798221`（已满）~~
  - ~~官方2群：`738179721`（已满）~~
  - ~~官方3群：`874761842`（已满）~~
