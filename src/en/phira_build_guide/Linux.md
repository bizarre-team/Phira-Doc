...
- **Note: At the time of writing this document, the resource files in the code directory are not complete. If you find that the main program crashes, you can go to the [release](https://github.com/TeamFlos/phira/releases) page to download any version to obtain the missing resource files.**
